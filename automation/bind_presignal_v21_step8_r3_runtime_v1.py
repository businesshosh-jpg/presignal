...
def forecast_prompt(input_row: Mapping[str, Any], provider: str, spec: Mapping[str, Any] | None = None) -> str:
    ...
    rule = module.PROMPT_RULES["gemini_pips"] if provider == "Gemini" else module.PROMPT_RULES["openai_reversal"] if provider == "OpenAI" else module.PROMPT_RULES["anthropic_json"]
