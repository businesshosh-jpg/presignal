...
class R6CompatibilityTests(unittest.TestCase):
    ...
    def test_contract_and_anthropic_settings_are_manifest_bound(self):
        ...
        self.assertEqual(gate["contract"]["contract_version"], r3.CONTRACT_VERSION)
    ...
    def test_request_priority_is_strict_and_other_is_exactly_normalized(self):
        ...
        self.assertEqual(provenance["normalizations"][0]["original_value"], "other")
    ...
    def test_raw_response_is_persisted_before_anthropic_parser_rejection(self):
        ...
        identity = {"run_id": loop.run.name, "session_id": "S", "episode_id": "E", "provider": "Anthropic", "model": "claude-haiku-4-5", "stage": "ATTENTION", "information_arm": None, "contract_fingerprint": r3.spec()["contract_fingerprint"], "attempt_number": 1}
