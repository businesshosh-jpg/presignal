...
def normalize_response(raw_response: Any, transport: Mapping[str, Any], raw_checksum: str) -> tuple[dict[str, Any], list[dict[str, Any]], dict[str, Any]]:
    ...
    for order, item in enumerate(normalized_items, 1):
        ...
        provenance = {"raw_response_checksum": raw_checksum, "normalized_response_checksum": normalized["normalized_response_checksum"], "request_authorization_fingerprint": AUTH_FP, "attention_content_checksum": "sha256:223025d1db8be393b8426fbca149ff19e77cc585328d97f61967116613a4ccbe", "raw_payload_provider_value": raw.get("provider")}
...
def pack_authorization(rows: list[Mapping[str, Any]], request_set_checksum: str) -> dict[str, Any]:
    value = {"authorization_name": PACK_AUTH_NAME, "status": "PREPARED_NOT_ACTIVATED", "episode_identity": EPISODE, "attention_identity": ATTENTION,
             "episode_selection_authorization_fingerprint": SELECTION_FP, "attention_content_checksum": "sha256:223025d1db8be393b8426fbca149ff19e77cc585328d97f61967116613a4ccbe", "attention_provenance_checksum": "sha256:f3d72bce8d9f20065446c92aac5044f3e428921beb20cd4a6ce350d4d6c4da91", "attention_lineage_checksum": "sha256:013be496bbbd13cf4bf61c04db77a931ba1da58e8eab4fc15c91cac87675a469", "request_authorization_fingerprint": AUTH_FP, "canonical_request_identities": [row["request_identity"] for row in rows], "request_set_checksum": request_set_checksum, "request_prompt_checksum": PROMPT_SHA, "category_enum_checksum": CATEGORY_SHA, "temporal_alignment_fingerprint": TEMPORAL_FP, "route_b_freeze_fingerprint": ROUTE_B_FREEZE, "forecast_cutoff": CUTOFF, "pack_a_scope": "selected provider ordered canonical Information Request set", "pack_e_scope": "shared approved market-state acquisition path", "authorization_activated": False, "pack_a_constructed": False, "pack_e_constructed": False, "forecast_calls": 0, "outcome_operations": 0, "evaluation_operations": 0}
