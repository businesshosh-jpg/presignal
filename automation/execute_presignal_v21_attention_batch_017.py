#!/usr/bin/env python3
"""Execute or fail-closed ATTN_BATCH_017 from the frozen Attention execution plan."""
...
BATCH_ID = "ATTN_BATCH_017"
EXPECTED_CALL_COUNT = 12
EXPECTED_START_HEAD = "f15aab49ab7726ace6956c2642a134df90c3cb7d"
...
GOVERNING_BATCHES_013_014_COORDINATION_ID = "PPHB-R1-ATTENTION-EXECUTION-BATCHES-013-014-20260729T082604Z-c3a0b88a7816"
GOVERNING_BATCH_013_EXECUTION_ID = "PPHB-R1-ATTENTION-EXECUTION-BATCH-013-20260729T082604Z-f9f471494171"
GOVERNING_BATCH_014_EXECUTION_ID = "PPHB-R1-ATTENTION-EXECUTION-BATCH-014-20260729T082854Z-a906012f07c8"
GOVERNING_AUTH_RECOVERY_015_016_ID = "PPHB-R1-ATTENTION-AUTH-RECOVERY-AND-BATCHES-015-016-20260729T093506Z-c17b34484144"
GOVERNING_BATCH_015_EXECUTION_ID = "PPHB-R1-ATTENTION-EXECUTION-BATCH-015-20260729T093506Z-9cbf6043b4aa"
GOVERNING_BATCH_016_EXECUTION_ID = "PPHB-R1-ATTENTION-EXECUTION-BATCH-016-20260729T093902Z-d591d2f9d944"


def load_batch_calls() -> list[dict[str, Any]]:
    calls = batch004.base.load_batch_calls(BATCH_ID)
    if len(calls) != EXPECTED_CALL_COUNT:
        raise batch004.base.AttentionBatchError("BATCH_017_CALL_COUNT_MISMATCH")
    ...
    if overlap:
        raise batch004.base.AttentionBatchError("BATCH_017_OVERLAPS_PRIOR_BATCH:" + ",".join(overlap))
    return calls
...
def patched_batch004() -> Any:
    ...
    batch004.RUN_ID_PREFIX = "PPHB-R1-ATTENTION-EXECUTION-BATCH-017-"
    batch004.EXECUTION_STATUS_COMPLETE = "ATTENTION_BATCH_017_COMPLETE"
    batch004.EXECUTION_STATUS_PARTIAL = "ATTENTION_BATCH_017_PARTIALLY_COMPLETE"
    batch004.EXECUTION_STATUS_BLOCKED = "ATTENTION_BATCH_017_BLOCKED"
    batch004.SCALING_READY = "READY_FOR_ATTENTION_RESULT_CONSOLIDATION"
    batch004.SCALING_REPAIR = "REPAIR_REMAINING_ATTENTION_CALLS"
    batch004.SCALING_RETRY = "RETRY_FAILED_BATCH_017_CALLS_REQUIRES_AUTHORIZATION"
    batch004.FAILED_CALL_RETRY_RECOMMENDATION = "NO_AUTOMATIC_RETRY_IN_BATCH_017"
    try:
        yield
    finally:
...
def patch_run_metadata(run_dir: Path) -> None:
    for path in (
        ...
        data["governing_batches_013_014_coordination_id"] = GOVERNING_BATCHES_013_014_COORDINATION_ID
        data["governing_batch_013_execution_id"] = GOVERNING_BATCH_013_EXECUTION_ID
        data["governing_batch_014_execution_id"] = GOVERNING_BATCH_014_EXECUTION_ID
        data["governing_auth_recovery_015_016_id"] = GOVERNING_AUTH_RECOVERY_015_016_ID
        data["governing_batch_015_execution_id"] = GOVERNING_BATCH_015_EXECUTION_ID
        data["governing_batch_016_execution_id"] = GOVERNING_BATCH_016_EXECUTION_ID
