...
from automation import run_presignal_v21_single_event_path_pair_v1 as step6
...
def response() -> dict:
    return {
        "no_signal_flag": False, "no_signal_reason": None, "confidence": 0.61, "expected_initial_direction": "UP",
